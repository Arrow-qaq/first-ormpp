...
//     dbng<mysql> mysql;
//     TEST_REQUIRE(mysql.connect(ip, "root", "123456", "testdb", /*timeout_seconds=*/5, 3306));
//     dummy d{ 0, "tom" };
//     dummy d1{ 0, "jerry" };
//     mysql.insert(d);
//     mysql.insert(d1);
...
// #ifdef ORMPP_ENABLE_MYSQL
//     dbng<mysql> mysql;
//     TEST_REQUIRE(mysql.connect(ip, "root", "123456", "testdb"));
//     TEST_REQUIRE(mysql.disconnect());
//     TEST_REQUIRE(mysql.connect(ip, "root", "123456", "testdb", timeout));
// #endif
//
// #ifdef ORMPP_ENABLE_SQLITE3
//     dbng<sqlite> sqlite;
...
int main()
{
	...
	dbng<mysql> mysql;
	mysql.connect("127.0.0.1", "root", "123456", "testdb");
